package com.example.msngr.database
...
import com.example.msngr.utilits.AppValueEventListener
...
//root ссылка, которая обращается к RealTime DataBase
