package com.example.msngr.ui.screens.single_chat
...
import com.example.msngr.models.UserModel
import com.example.msngr.ui.message_recycler_view.views.AppViewFactory
...
class SingleChatFragment(private val contact: CommonModel) :
                    ...
                    if (event.action == MotionEvent.ACTION_DOWN) {
                        ...
                        chat_btn_voice.setColorFilter(
                            ContextCompat.getColor(
                                APP_ACTIVITY, com.mikepenz.materialize.R.color.primary
                            )
                        )
    ...
    //участок кода, срабатывающий в момент, когда мы кликаем на троеточие
