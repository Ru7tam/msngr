...
import com.example.msngr.database.updatePhonesToDatabase
...
//функция для вызова Toast
fun showToast(message: String) {
    Toast.makeText(APP_ACTIVITY, message, Toast.LENGTH_SHORT).show()
}

//функция для переключения между Activity
fun restartActivity() {
...
//функция для переключения от Activity к Fragment
